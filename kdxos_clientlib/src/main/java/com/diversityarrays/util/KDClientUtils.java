...
public class KDClientUtils {
	...
	public static final Color DARK_GREEN = Color.decode("#006600"); //$NON-NLS-1$
	...
	static public Cursor getEraserCursor(boolean small) {
        return getCursor(ImageId.ERASER_24, small, "Eraser",
    ...
    static public Optional<Image> getImage(InputStream is) {
    	Image result = null;
    	if (is != null) {
    		try {
