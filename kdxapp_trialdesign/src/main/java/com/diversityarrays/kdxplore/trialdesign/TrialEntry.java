...
public class TrialEntry extends DesignEntry {
    ...
    public TrialEntry(int seq, String loc, String exp, int entryId, String name, EntryType type, String nest, Map<EntryFactor,String> map) {
        super(seq, loc, exp, entryId, name, type, map);
        this.nesting = nest;
    }
