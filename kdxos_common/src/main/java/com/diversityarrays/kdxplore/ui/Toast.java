...
public class Toast {
    ...
    public Toast(JComponent owner, Point where, JComponent contents, long durationMillis) {
        this.owner = owner;
        this.where = where;
    ...
    public Toast(JComponent owner, String message, long durationMillis) {
    ...
    public Toast(JComponent owner, Point where, String message, long durationMillis) {
        this.owner = owner;
        this.where = where;
