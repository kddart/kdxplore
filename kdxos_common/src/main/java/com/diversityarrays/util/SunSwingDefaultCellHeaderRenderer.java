...
public class SunSwingDefaultCellHeaderRenderer extends DefaultTableCellRenderer
        implements UIResource {
    private boolean horizontalTextPositionSet;
    private Icon sortArrow;
    private EmptyIcon emptyIcon = new EmptyIcon();

    public SunSwingDefaultCellHeaderRenderer() {
    ...
    public Component getTableCellRendererComponent(JTable table, Object value,
        ...
        if (table != null) {
            ...
            if (header != null) {
                ...
                Color bgColor = null;
                if (hasFocus) {
                    fgColor = SunSwingDefaultLookup.getColor(this, ui, "TableHeader.focusCellForeground");
                    bgColor = SunSwingDefaultLookup.getColor(this, ui, "TableHeader.focusCellBackground");
                }
                if (fgColor == null) {
            ...
            if (!isPaintingForPrint && table.getRowSorter() != null) {
                ...
                if (sortOrder != null) {
                    switch(sortOrder) {
                    case ASCENDING:
                        sortIcon = SunSwingDefaultLookup.getIcon(
        ...
        Border border = null;
        if (hasFocus) {
            border = SunSwingDefaultLookup.getBorder(this, ui, "TableHeader.focusCellBorder");
        }
        if (border == null) {
            border = SunSwingDefaultLookup.getBorder(this, ui, "TableHeader.cellBorder");
        }
        setBorder(border);
    ...
    public void paintComponent(Graphics g) {
        boolean b = SunSwingDefaultLookup.getBoolean(this, ui,
