...
public class SuppressChangeableGroup implements Changeable<PlotAndSampleChanger> {

	private final List<SuppressChangeable> changeables;
	private final String newReason;
	
	public SuppressChangeableGroup(List<SuppressChangeable> changeables, String newReason) {
	...
	public String getInfo() {
		if (newReason==null) {
			return "Unsuppress " + changeables.size() + " Samples";
		}
		return "Suppress " + changeables.size() + " Samples: " + newReason;
	}
