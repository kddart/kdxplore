...
public class SuppressionData {
	public final SuppressOption suppressOption;
	...
	public final List<CurationCellValue> curationCellValues;
	
	public SuppressionData(SuppressOption option,
	        boolean askAboutValueForUnscored,
			List<KdxSample> editedSamples, 
			List<KdxSample> nonEditedSamples, 
			List<CurationCellValue> ccvs)
	{
		this.suppressOption = option;
